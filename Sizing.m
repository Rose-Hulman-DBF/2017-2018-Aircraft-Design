function [Report_Weight_Table,S_computed] = Sizing(W__S_design,...
    P__W_design,W_batt__W_TO,N_missiles,S)

%Weights
W_servo     = .4/16;   %Servo weight (lbf)
N_servos    = 6;       %Number of servos

load Geometry.mat S_wet_fuse__S S_h S_v
load CA_MA.mat W_missile
...
W_struct__S = 0.15*S_wet_fuse__S + .2*(S_h/S+S_v/S); %lbs (from aero design)
...
S_computed = W_missiles/(W__S_design - W_batt__S - W_struct__S -...
    W_wing__S - W_eng__S - W_sys__S)
